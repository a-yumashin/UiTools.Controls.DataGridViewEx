...
{
    internal class DropDownMenuScrollWheelHandler : IMessageFilter
    {
        ...
        private static readonly MethodInfo ScrollInternal =
            typeof(ToolStrip).GetMethod("ScrollInternal", BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        private void handleDelta(ToolStripDropDown ts, int delta)
        {
            ...
            if (delta != 0)
                ScrollInternal.Invoke(ts, new object[] { delta });
        }
    }
}
